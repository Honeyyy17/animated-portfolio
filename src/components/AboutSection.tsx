...
import aboutImg from '../assets/bhimarao-walking-frame.png';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Bhimarao Koli</span>, a software developer and AIML student at R. V. College of Engineering, Bangalore. I build intelligent, secure, full-stack products with a foundation in data structures, algorithms, statistical analysis, and real-world problem solving.
            </motion.p>
