...
import heroCharacterImg from '../assets/hero-character.jpg';
...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative w-screen h-screen overflow-hidden bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black cursor-none">
      ...
      {/* Hero Subject - Single Perfect Full-Body Character Portrait in Circled Center Area */}
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none bg-black flex items-center justify-center">
        <img
          ...
          alt="Bhimarao Koli"
          className="absolute bottom-0 left-1/2 md:left-[54%] lg:left-[56%] -translate-x-1/2 h-[92vh] sm:h-[95vh] w-auto max-w-none object-contain object-bottom origin-bottom opacity-95"
        />

        {/* Seamless Soft Left Edge Blend */}
        <div className="absolute inset-y-0 left-0 w-2/5 bg-gradient-to-r from-black via-black/75 to-transparent pointer-events-none z-10" />
          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="mb-4">
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                SOFTWARE DEVELOPER <span className="text-[#8C6D4F] mx-1">•</span> AIML ENGINEER <span className="text-[#8C6D4F] mx-1">•</span> CYBER SECURITY
              </p>
            </motion.div>
            ...
            >
              <p>
                I build intelligent systems and dependable web experiences.
                <br />
                From AI-powered products to secure, full-stack applications, I turn ideas into practical impact.
              </p>
            </motion.div>
