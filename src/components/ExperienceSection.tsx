...
const journey: RouteStop[] = [
  {
    id: '01',
    year: '2026 - PRESENT',
    title: 'BACHELOR OF AIML',
    organization: 'R. V. COLLEGE OF ENGINEERING, BANGALORE',
    description: 'Pursuing a Bachelor degree in Artificial Intelligence and Machine Learning.',
  },
  {
    id: '02',
    year: '2026',
    title: 'AI RESEARCH MILESTONE',
    organization: 'DOCUMENT CLASSIFICATION MODEL',
    description: 'Filed a patent and published a paper for an AI-integrated document classification model.',
  },
  {
    id: '03',
    year: '2024 - 2026',
    ...
    description: 'Developed and hosted more than 10 websites for clients using modern web technologies.',
  },
  {
    id: '04',
    year: '2021 - 2024',
    title: 'DIPLOMA IN COMPUTER SCIENCE',
    organization: 'JAIN POLYTECHNIC, BELAGAVI',
    description: 'Built a strong foundation in computer science, programming, and technical problem solving.',
  },
  {
    id: '05',
    year: 'CERTIFICATIONS',
    title: 'CONTINUOUS LEARNING',
    organization: 'NPTEL & INFOSYS',
    description: 'NPTEL Certified Software Developer, NPTEL Certified Data Science Engineer, and Infosys Certified Cloud Engineer.',
  },
];
