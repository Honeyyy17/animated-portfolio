...
const projects: Project[] = [
  {
    ...
    description:
      'AI-integrated plant disease detection project that applies machine learning to identify diseases from plant imagery and support timely, data-informed care.',
    githubUrl: 'https://github.com/Honeyyy17',
    tech: [
      'Python', 'AI/ML', 'Computer Vision', 'Web Development',
    ],
    metrics: [
      { label: 'DOMAIN', value: 'Agriculture' },
      { label: 'ENGINE', value: 'AI / ML' },
      { label: 'FOCUS', value: 'Disease Detection' },
    ],
  },
  {
    number: '02',
    ...
    description:
      'AI-integrated document classification model for organizing and understanding documents. The project has a filed patent and published paper.',
    githubUrl: 'https://github.com/Honeyyy17',
    tech: [
      'Python', 'AI/ML', 'Document Processing', 'Analytics',
    ],
    metrics: [
      { label: 'MODEL', value: 'AI Classification' },
      { label: 'STATUS', value: 'Patent Filed' },
      { label: 'RESEARCH', value: 'Paper Published' },
    ],
  },
  {
    number: '03',
    title: 'Network Intrusion Detection',
    category: 'CYBER SECURITY / AIML',
    description:
      'A network intrusion detection system designed to identify threats and strengthen the security posture of connected systems.',
    githubUrl: 'https://github.com/Honeyyy17',
    tech: [
      'Cyber Security', 'Networking', 'Python', 'Analytics',
    ],
    metrics: [
      { label: 'DOMAIN', value: 'Network Security' },
      { label: 'FOCUS', value: 'Threat Detection' },
      { label: 'METHOD', value: 'Analytics' },
    ],
  },
  {
    number: '04',
    title: 'Prompt Manager & Generator',
    category: 'AI / PRODUCTIVITY TOOL',
    description:
      'A developer-focused tool for organizing, generating, and refining prompts for AI workflows.',
    githubUrl: 'https://github.com/Honeyyy17',
    tech: [
      'MERN', 'JavaScript', 'AI Tools', 'Web Development',
    ],
    metrics: [
