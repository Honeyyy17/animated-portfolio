...
const bentoCategories = [
  {
    ...
    badge: 'CORE PILLAR',
    items: ['HTML', 'CSS', 'JavaScript', 'MERN'],
    description: 'Building responsive web applications and client websites from idea to deployment.',
    stat: '10+ WEBSITES',
  ...
  },
  {
    ...
    description: 'Strong foundations in programming, data structures, algorithms, and analytical problem solving.',
    stat: 'DSA READY',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'AIML & ANALYTICS',
    badge: 'INTELLIGENCE',
    items: ['Machine Learning', 'Statistical Analysis', 'Predictive Modeling', 'AI'],
    description: 'Exploring intelligent systems that transform data into useful decisions and real-world solutions.',
    stat: 'AIML STUDENT',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'SECURITY & TEAMWORK',
    badge: 'PROFESSIONAL',
    items: ['Cyber Security', 'Networking', 'Communication', 'Collaboration'],
    description: 'Combining security awareness with clear communication and collaborative delivery.',
    stat: 'NPTEL CERTIFIED',
    colSpan: 'lg:col-span-7',
  },
];
